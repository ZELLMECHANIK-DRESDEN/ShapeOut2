...
# -*- coding: utf-8 -*-
#
# Shape-Out 2 documentation build configuration file, created by
...
# Get version number from shapeout2._version file
...
rst_prolog = """
:github_url: https://github.com/ZELLMECHANIK-DRESDEN/ShapeOut2
"""
...
project = 'Shape-Out 2'
github_project = 'ZELLMECHANIK-DRESDEN/ShapeOut2'
...
# This gets 'version'
exec(open(op.join(pdir, "shapeout2/_version.py")).read())
...
htmlhelp_basename = 'shapeout2doc'
...
latex_documents = [
    (master_doc, 'shapeout2.tex', 'Shape-Out 2 Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'shapeout2', 'Shape-Out 2 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'shapeout2', 'Shape-Out 2 Documentation',
     author, 'shapeout2', 'post-measurement analysis of RT-DC data sets',
     'Scientific'),
]
